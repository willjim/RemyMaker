...
RemyMaker 是一款面向桌面端、平板与手机端的 3D 高斯泼贱特效和运镜工具。它支持加载 Remy3D 与 Kiri Engine 分享链接，在粒子模式和 3D 实景之间切换，并通过内置运镜预设或自定义关键帧导出高清视频。
...
- 粒子大小、粒子亮度、密度和背景裁剪调节
- 9 种粒子消散重组特效，并提供「无需粒子特效」选项
- 16 套内置镜头运镜预设，包括水平环绕、希区柯克变焦、盗梦空间缓慢推进旋转等
